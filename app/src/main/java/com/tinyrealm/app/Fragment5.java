...
//***************************************************************
// Fragment5:: Implements the page#5 fragment. This fragment is used for the
// part of the story the boy finds a bone instead of treasure.
//***************************************************************
public class Fragment5 extends Fragment{
    private ImageButton imgBtnDogAnimation;
    private View view;
    private boolean clicked;
    private ImageView imgViewPage5;
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.pg5, container, false);

        //Invisible button laying over the Parrot
        imgBtnDogAnimation = (ImageButton) view.findViewById(R.id.imageButton1Pg5);
        ...
        imgViewPage5 = (ImageView) view.findViewById(R.id.imageView5);

        //Button used to display a Toast message for the HINT
        hint = (Button) view.findViewById(R.id.buttonClue5);

        //Media player used to play the parrot sounds
        mp = MediaPlayer.create(view.getContext(), R.raw.page5dogwantsbone);

        //Image Button used to play the Narration
        imgBtnPlaySound = (ImageButton) view.findViewById(R.id.imageButtonPlaySound5);

        //Media Player used to play the narration
        mpNarrate = MediaPlayer.create(view.getContext(), R.raw.narrate5);
        ...
        //***************************************************************
        imgBtnDogAnimation.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CharSequence text = "Hint: Touch the picture to hear Woofy!";
