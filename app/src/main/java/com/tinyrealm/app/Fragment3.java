...
public class Fragment3 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.pg3, container, false);

        //Invisible button laying over the Parrot
        imgButtonDogAnimation = (ImageButton) view.findViewById(R.id.imageButton1Pg3);
        ...
        imgViewPage1 = (ImageView) view.findViewById(R.id.imageView3);

        //Button used to display a Toast message for the HINT
        hint = (Button) view.findViewById(R.id.buttonClue3);

        //Media player used to play the parrot sounds
        mp = MediaPlayer.create(view.getContext(), R.raw.dogbark);

        //Image Button used to play the Narration
        imgBtnPlaySound = (ImageButton) view.findViewById(R.id.imageButtonPlaySound3);

        //Media Player used to play the narration
        mpNarrate = MediaPlayer.create(view.getContext(), R.raw.narrate3);
        ...
        imgButtonDogAnimation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clicked) {
                    ...
                    imgViewPage1.setBackgroundDrawable(getResources().getDrawable(R.drawable.page3startanimate));
                    clicked = false;

                } else {
                    imgViewPage1.setBackgroundDrawable(getResources().getDrawable(R.drawable.page3basic));
                    if (!mp.isPlaying()) {
        ...
        hint.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CharSequence text = "Hint: Tap the dog and make him bark!";
